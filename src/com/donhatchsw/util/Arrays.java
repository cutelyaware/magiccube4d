...
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// !!! THIS FILE WAS AUTOMATICALLY GENERATED BY javacpp; DO NOT EDIT !!!
// 102 # 1 "com/donhatchsw/util/Arrays.prejava"
// 103 # 1 "<built-in>"
// 104 # 1 "<command-line>"
...
// 150 # 1 "com/donhatchsw/util/Arrays.prejava"

// 152 # 1 "com/donhatchsw/util/Arrays.prejava"
 ...
 *      <li> get() taking additional integer argument specifying dimension of array being indexed into (see getMany())</li>
...
public final class Arrays
{
    ...
    public static Object subarray(Object array, int start, int n, boolean which[])
    {
        ...
        do { if (!((iNew)==(subarrayLength))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+119 +"): (" + "iNew" + ")" + "==" + "(" + "subarrayLength" + ") ("+(iNew)+" vs. "+(subarrayLength)+")"); } while (false);
        return subarray;
    } // subarray with which
    ...
    // could just do append(v, Double.valueOf(last))
    ...
    // CBB: add double and float versions of this
    public static int[] prepend(int v[], int first)
    {
        int i, n = v.length;
        int result[] = new int[n+1];
    ...
    */
    ...
    {
        do { if (!(depth >= 1)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+259 +"): " + "depth >= 1" + ""); } while (false); // XXX should be param check throwing exception
        {
            int n = java.lang.reflect.Array.getLength(from);
            do { if (!((n)==(java.lang.reflect.Array.getLength(to)))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+262 +"): (" + "n" + ")" + "==" + "(" + "java.lang.reflect.Array.getLength(to)" + ") ("+(n)+" vs. "+(java.lang.reflect.Array.getLength(to))+")"); } while (false);
            if (depth == 1)
    ...
    public static Object copy(Object from, int depth)
    {
        if (depth == 0)
            return from;
        do { if (!(depth >= 1)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+278 +"): " + "depth >= 1" + ""); } while (false); // XXX should be param check throwing exception
        {
            int n = java.lang.reflect.Array.getLength(from);
     ...
     *
     * <p>
     * XXX should make a version that takes the result as an argument rather than allocating a new one
    ...
    /**
     * sub() is an alias for getMany().
     */
    public static Object sub(Object array, Object indices) {
        return getMany(array, indices);
    }
    ...
    // YYY (Not sure what I was talking about, now)
    ...
    {
        do { if (!(depth >= 1)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+505 +"): " + "depth >= 1" + ""); } while (false); // XXX should be param check throwing exception
        {
            if (depth == 1)
            {
                if (which == null)
                                      ...
                                      int furtherDepth)
    {
        ...
        if (startDepth == 0)
            return Integer.valueOf(arrayLength(array, furtherDepth));
    ...
    private static Class<?> getComponentType(Object array, int depth)
    {
        ...
        do { if (!(depth > 0)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+606 +"): " + "depth > 0" + ""); } while (false);
        int n = java.lang.reflect.Array.getLength(array);
        for (int i = 0; (i) < (n); ++i)
        {
    ...
    public static Object makeArrayOfIndices(Object array, int depth)
    {
        ...
        private static Object _makeArrayOfIndices(Object array, int depth, int currentIndex[])
        {
            ...
            {
                do { if (!(depth > 1)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+680 +"): " + "depth > 1" + ""); } while (false); // XXX should be param check throwing exception
                Object inds[] = (Object[])java.lang.reflect.Array.newInstance(
                                    Arrays.getClassOfArrayOf(int[].class, depth-1),
                                    arrayLength);
                do { if (!((getDim(inds))==(depth+1))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+684 +"): (" + "getDim(inds)" + ")" + "==" + "(" + "depth+1" + ") ("+(getDim(inds))+" vs. "+(depth+1)+")"); } while (false);
                for (int i = 0; (i) < (arrayLength); ++i)
                {
                    currentIndex[indexIntoCurrentIndex] = i;
                                 ...
                                 int furtherDepth)
    {
        ...
        if (startDepth == 0)
        {
            ...
            do { if (!((pos)==(nFlat))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+746 +"): (" + "pos" + ")" + "==" + "(" + "nFlat" + ") ("+(pos)+" vs. "+(nFlat)+")"); } while (false);
        }
        else
        {
            do { if (!(startDepth >= 1)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+750 +"): " + "startDepth >= 1" + ""); } while (false); // XXX should be params check
                                    ...
                                    int nDimsToFlattenIntoOne)
        {
            ...
            {
                do { if (!(nDimsToFlattenIntoOne >= 2)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+781 +"): " + "nDimsToFlattenIntoOne >= 2" + ""); } while (false); // XXX should be params check
                int n = java.lang.reflect.Array.getLength(array);
                for (int i = 0; (i) < (n); ++i)
    ...
    {
        return (double[])fill(n, Double.valueOf(item));
    }

    public static void reverse(int to[], int from[], int n)
    {
        if (to == from)
        {
            int temp;
    ...
    {
        int n = from.length;
        do { if (!((n)==(to.length))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+843 +"): (" + "n" + ")" + "==" + "(" + "to.length" + ") ("+(n)+" vs. "+(to.length)+")"); } while (false);
        reverse(to, from, n);
    } // reverse, int
    public static void reverse(Object to, Object from, int n)
    {
        if (to == from)
        {
            int halfN = n/2; // rounded down
    ...
    {
        int n = java.lang.reflect.Array.getLength(from);
        do { if (!((n)==(java.lang.reflect.Array.getLength(to)))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+864 +"): (" + "n" + ")" + "==" + "(" + "java.lang.reflect.Array.getLength(to)" + ") ("+(n)+" vs. "+(java.lang.reflect.Array.getLength(to))+")"); } while (false);
        reverse(to, from, n);
    } // reverse, general
                                          ...
                                          Object array1, int i1)
    {
        ...
        {
            do { if (!(false)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+1019 +"): " + "false" + ""); } while (false); // XXX implement me better! need to convert all numbers to double, I think.   this really sucks
            return false;
        }
    } // subEqualsSymbol
                                  ...
                                  String suffix)
    {
        ...
        if (array instanceof java.util.ArrayList) {
            array = ((java.util.ArrayList)array).toArray();
        }
    ...
    public static String toStringCompact(byte x) { return toStringCompact(Byte.valueOf(x)); }
    public static String toStringCompact(double x) { return toStringCompact(Double.valueOf(x)); }
    public static String toStringCompact(float x) { return toStringCompact(Float.valueOf(x)); }
    public static String toStringCompact(int x) { return toStringCompact(Integer.valueOf(x)); }
    public static String toStringCompact(long x) { return toStringCompact(Long.valueOf(x)); }
    public static String toStringCompact(short x) { return toStringCompact(Short.valueOf(x)); }
    public static String toStringCompact(boolean x) { return toStringCompact(Boolean.valueOf(x)); }
    public static String toStringCompact(char x) { return toStringCompact(Character.valueOf(x)); }
        ...
        extends java.text.Format
    {
        ...
        //
                ...
                throws java.text.ParseException
            {
                ...
                else if (clazz == char.class)
                {
                    ...
                    int i = pos.getIndex();
                    do { if (!(end-i >= 3 && s.charAt(i+0) == '\'' && s.charAt(i+2) == '\'')) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+1380 +"): " + "end-i >= 3 && s.charAt(i+0) == '\\'' && s.charAt(i+2) == '\\''" + ""); } while (false)

                                                ;
                    obj = Character.valueOf(s.charAt(i+1));
                    i += 3;
                    pos.setIndex(i);
                }
                else
        ...
        //
                ...
                throws java.text.ParseException
            {
                ...
                do { if (!(false)) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+1558 +"): " + "false" + ""); } while (false); // should never get here
                return null;
    ...
    public static void main(String args[])
    {
        if (true)
        {
            Integer thisZero = Integer.valueOf(0);
            Integer thatZero = Integer.valueOf(0);
            Integer thisOne = Integer.valueOf(1);
            Integer thatOne = Integer.valueOf(1);
            {System.out.print("        "); System.out.println("thisZero == thatZero" + " = " + (thisZero == thatZero));};
            {System.out.print("        "); System.out.println("thisZero == thatOne" + " = " + (thisZero == thatOne));};
            {System.out.print("        "); System.out.println("thisZero.equals(thatZero)" + " = " + (thisZero.equals(thatZero)));};
            {System.out.print("        "); System.out.println("thisZero.equals(thatOne)" + " = " + (thisZero.equals(thatOne)));};
            {System.out.print("        "); System.out.println("5.f == (long)5" + " = " + (5.f == (long)5));};
            {System.out.print("        "); System.out.println(".5f == (long)5" + " = " + (.5f == (long)5));};
            {System.out.print("        "); System.out.println("((long)1<<(long)34) == (((float)(1<<17)*(float)(1<<17)))" + " = " + (((long)1<<(long)34) == (((float)(1<<17)*(float)(1<<17)))));}
                                                    ;
            {System.out.print("        "); System.out.println("(((long)1<<(long)34) + (long)1) == (((float)(1<<17)*(float)(1<<17)) + (float)1)" + " = " + ((((long)1<<(long)34) + (long)1) == (((float)(1<<17)*(float)(1<<17)) + (float)1)));}
                                                               ;
        ...
        {
            String s = "  {  {  {  1  ,  2  }  ,  null  }  }  ";
            {System.out.print("        "); System.out.println("s" + " = " + (s));};
            java.text.ParsePosition pos = new java.text.ParsePosition(0);
            try
            {
        ...
        if (true)
        {
            ...
            for (int i = 0; (i) < (100); ++i)
            {
                ...
                for (int j = 0; (j) < (100); ++j)
                {
                    ...
                    do { if (!(((0 <=(n))&&((n)< i)))) throw new Error("CHECK failed at "+"com/donhatchsw/util/Arrays.prejava"+"("+1751 +"): " + "INRANGE(0 <=, n, < i)" + ""); } while (false);
                }
                System.out.println();
            }
        }
